...
please refer to the Cheetah user manual and the example source code
available on the Total Phase website.
...
user manual and the Cheetah Python API.
...
Open Source
-----------
When running on Linux and Mac OS X, this software uses a modified
